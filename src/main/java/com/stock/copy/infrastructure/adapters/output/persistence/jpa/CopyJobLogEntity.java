...
/**
 * Entidad JPA para el log de idempotencia de copia de stock.
 * DDL PostgreSQL: TIMESTAMPTZ + UNIQUE (id_proceso, fase, modulo).
 * REQ-STOCK-01, ADR-38.
 */
@Entity
@Table(name = "stock_copy_job_log",
    uniqueConstraints = {
        @UniqueConstraint(name = "uq_stock_copy_job_log",
                columnNames = {"id_proceso", "fase", "modulo"})
    },
    indexes = {
        @Index(name = "idx_stock_copy_job_log_id_proceso", columnList = "id_proceso")
    }
)
@Data
@Builder
